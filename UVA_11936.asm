...
MAIN PROC 
     ...
     MOV P,0     
     MOV AX,P
     CMP AX,T   ;for(p=0;p<t;p++) outer loop->test case loop
     JL TOP
     JMP EXIT 
  ...
  ;SORTING END   
     ...
     ADD AX,BX    ;if(A[0]+A[1]>A[2])
     CMP AX,DX    ; then print OK
     JG PRINT_OK
     
     LEA DX,WRONG ;else 
     MOV AH,9     ;   print Wrong
     INT 21H
     CALL NEWLINE
     JMP END_WORK
     ...
     END_WORK: 
             CALL NEWLINE  ;set the outer loop appropriately
             INC P
             MOV AX,P
             CMP AX,T
             JL TOP   
